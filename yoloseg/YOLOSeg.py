...
from yoloseg.utils import xywh2xyxy, nms, draw_detections, sigmoid, caculate_depth
...
# ************************ mới mở hàng dưới
    ...
    def caculate_depth(self,i, image, draw_scores=True, mask_alpha=0.5):
        return caculate_depth(i, image, self.boxes, self.scores,
                               self.class_ids, mask_alpha, mask_maps=self.mask_maps)
